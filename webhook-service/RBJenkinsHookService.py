...
def result():
    ...
    if ('job' in request.form and
        'REVIEW_URL' in request.form and
        'review_id' in request.form and
        'review_commit_id' in request.form):
        ...
        app.logger.info('ERROR: Missing parameter')
